...
function DemoSection() {
  return (
    <section className="px-4 pb-16 md:px-8 md:pb-24" id="demo">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-ink/15 bg-gradient-to-r from-blush via-cream to-ivory p-6 shadow-premium md:p-12">
        ...
        <div className="mt-5 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            <h2 className="font-serif text-3xl leading-tight text-ink md:text-5xl">Entrez dans l ambiance avant même le jour J.</h2>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-7 inline-flex w-full justify-center rounded-full bg-ink px-7 py-3 text-sm font-semibold uppercase tracking-[0.12em] text-ivory transition hover:-translate-y-0.5 hover:bg-ink/90 sm:w-auto"
            >
              Voir la démo
            </a>
          </div>
          <div className="rounded-3xl border border-ink/10 bg-white/75 p-6">
            ...
            <p className="pt-2 text-sm font-medium text-ink/65">Moins de charge mentale pour vous. Plus de clarté pour tout le groupe.</p>
          </div>
        </div>
      </div>
    </section>
